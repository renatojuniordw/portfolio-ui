    ...
    <div className="min-h-screen bg-bg relative overflow-hidden flex flex-col items-center py-20 px-6">
      ...
      <div className="w-full max-w-[480px] space-y-12 text-center relative z-10">
        ...
        <main className="space-y-8 pb-10">
          {/* Main Destination */}
          <section className="space-y-3" aria-labelledby="websites-title">
            <h2
              id="websites-title"
          ...
          {/* Social Social */}
          <section className="space-y-3" aria-labelledby="social-title">
            <h2
              id="social-title"
              className="text-[10px] font-bold uppercase tracking-widest text-muted"
            >
          ...
          <section
            className="space-y-3"
            aria-labelledby="barraco-channels-title"
          >
            <h2
              id="barraco-channels-title"
              className="text-[10px] font-bold uppercase tracking-widest text-muted"
            >
              Canais do Barraco
            </h2>
