        ...
        <div className="md:col-span-2 space-y-12">
          ...
          <section className="space-y-6">
            ...
            <div className="prose prose-invert max-w-none text-text-secondary space-y-4">
              <p>
                O desafio central do <strong>Unificando</strong> foi criar uma
                plataforma de atendimento que não apenas respondesse usuários,
                mas que entendesse a intenção de compra, calculasse orçamentos
                em tempo real e soubesse o momento exato de transferir para um
                humano.
              </p>
              <p>
                O sistema precisava ser resiliente a falhas e, acima de tudo,
                seguro contra <strong>prompt injections</strong> em ambientes
                públicos de rede social.
              </p>
            </div>
          </section>

          {/* Highlights Técnicos */}
          <section className="p-8 rounded-3xl bg-ia/5 border border-ia/20 space-y-8">
            <h2 className="text-2xl font-display font-bold font-space flex items-center gap-3">
              <Cpu className="text-ia" /> Inteligência de Decisão
            </h2>
            ...
            <div className="space-y-8 text-text-secondary">
              <div className="space-y-2">
                ...
                <p>
                  ...
                  intenções (Lead, FAQ, Pricing, Human) em milissegundos,
                  utilizando saída estritamente em JSON para integração direta
                  com webhooks.
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <p>
                  ...
                  bases de conhecimento dinâmicas, reduzindo a carga do suporte
                  humano em mais de 70%.
                </p>
              </div>
          ...
          <section className="space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {[
                ...
                {
                  icon: <ShieldCheck className="text-ia" size={24} />,
                  title: "QA de IA",
