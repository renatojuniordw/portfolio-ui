...
export default function NotFound() {
  return (
    <div className="min-h-screen bg-bg flex flex-col items-center justify-center p-6 relative overflow-hidden text-center selection:bg-text selection:text-bg">
      ...
      >
        <h1 className="text-[10rem] md:text-[15rem] font-light leading-none text-text/5 select-none tracking-tighter">
          404
        </h1>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
          <Button
            size="lg"
            className="bg-tech text-white px-8 rounded-full font-medium hover:brightness-110 transition-all w-full sm:w-auto"
            asChild
          >
            <Link href="/">
