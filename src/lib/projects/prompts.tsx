...
function Overview() {
  return (
    <p>
      O <strong>@unificando/prompts</strong> nasceu de um problema recorrente:
  ...
  return (
    <>
      ...
      <Button variant="outline" size="sm" className="w-full rounded-full" asChild>
        <a
          href="https://www.npmjs.com/package/@unificando/prompts"
          target="_blank"
...
export const promptsCase: ProjectCase = {
  id: "prompts",
  pathSegments: ["prompts"],
  ...
  jsonLd: {
    ...
    url: "https://github.com/Unificando/prompts",
  },
  ...
  liveUrl: "https://www.npmjs.com/package/@unificando/prompts",
  ...
  sidebarExtraCards: [
    {
      ...
      content: (
        <p className="text-sm text-text-secondary leading-relaxed">
          <code>npx @unificando/prompts list</code>
        </p>
      ),
    },
    {
