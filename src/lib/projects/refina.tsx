...
function Overview() {
  return (
    <p>
      ...
      conversando. O <strong>@unificando/refina</strong> é um{" "}
  ...
  return (
    <>
      <p className="text-sm text-text-secondary leading-relaxed mb-4">
        Publicado no npm e disponível via <code>npx</code> sem instalação.
      </p>
      <Button variant="outline" size="sm" className="w-full rounded-full" asChild>
        <a
          href="https://www.npmjs.com/package/@unificando/refina"
          target="_blank"
...
export const refinaCase: ProjectCase = {
  id: "refina",
  pathSegments: ["refina"],
  ...
  jsonLd: {
    ...
    url: "https://github.com/Unificando/refina",
  },
  ...
  liveUrl: "https://www.npmjs.com/package/@unificando/refina",
  ...
  sidebarExtraCards: [
    {
      ...
      content: (
        <p className="text-sm text-text-secondary leading-relaxed">
          <code>npx @unificando/refina &quot;sua ideia crua&quot; | claude</code>
        </p>
      ),
    },
    {
