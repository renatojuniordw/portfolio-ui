import { BookOpen, GraduationCap, History, ShieldAlert } from "lucide-react";
  ...
  return (
    <>
      <p>
        ...
        Desde então, a plataforma evoluiu para se tornar um acervo digital mantido
        pela comunidade.
      </p>
      <p>
        O principal objetivo deste site é garantir que as gerações futuras tenham
        acesso facilitado e estruturado às contribuições literárias, teatrais e
        filosóficas de Ariano, promovendo a rica cultura do Nordeste brasileiro.
      </p>
    </>
  );
}

export const arianoSuassunaCase: ProjectCase = {
  id: "ariano-suassuna",
  ...
  shortDescription: (
    <>
      ...
      <strong>Ariano Suassuna</strong>, preservando a cultura e memória nordestina
      na web.
    </>
  ),
  themeColor: "tech",
  ...
  sidebarExtraCards: [
    {
      ...
      content: (
        <p>
          ...
          oficial com os herdeiros, representantes legais ou editoras das obras de
          Ariano Suassuna.
        </p>
      ),
    },
