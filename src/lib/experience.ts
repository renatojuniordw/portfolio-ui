...
export const EXPERIENCES: Experience[] = [
  {
    ...
    responsibilities: [
      ...
      "**PDF Unificando** (pdf.unificando.com.br) — Suíte com **16 ferramentas de PDF** com **privacidade por design**: processamento server-side efêmero (arquivos em /tmp descartados após download, sem persistência), engine híbrida (pdf-lib/pdfjs-dist + Ghostscript, LibreOffice, Poppler, qpdf) e fila com controle de concorrência.",
      ...
      "**@unificando/prompts:** biblioteca de prompts publicada como **pacote npm/CLI** (npx @unificando/prompts list) com 6 templates (frontend, fullstack, backend, testes, auditoria de engenharia e segurança/LGPD), agnóstica de stack e de LLM.",
      '**@unificando/refina:** CLI via npx que monta prompts de engenharia a partir de texto cru, com pipe validado em Claude Code e Gemini CLI e persistência em .md (npx @unificando/refina "ideia" | claude).',
